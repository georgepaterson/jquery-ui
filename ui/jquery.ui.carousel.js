...
(function($, undefined) {
    ...
    options: {
		...
		_setTracker: function() {
			 ...
			 */
			var range = this.currentItem + this.options.visible - 1;
		...
		_updateTracker: function() {
			...
			var modulo = this.totalItems % this.options.visible,
				range = this.currentItem + this.options.visible - 1;
		...
		_navigationState: function() {
			 ...
			 */
			if((this.currentItem - this.options.visible) < 1){
			...
			if(this.currentItem > (this.totalItems - this.options.visible)){
		...
		_events: function() {
			...
			$('.ui-carousel-next a', this.element).click(function(element) {
				...
				if (self.currentItem <= (self.totalItems - o.visible)){
						self.carouselAnimation(direction, - self.distance);
	      }
			});				
		},
